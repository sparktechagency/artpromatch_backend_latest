...
const businessPreferencesSchema = new mongoose_1.Schema({
    businessId: {
...
const BusinessPreferences = (0, mongoose_1.model)('BusinessPreferences', businessPreferencesSchema);
exports.default = BusinessPreferences;
